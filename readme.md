...
#### **xpath-finder** has a minimalist **background page**, **popup button** and **content script**:
...
#### **xpath-finder** project has following configuration:
  ...
  * under `:unpacked` profile (development)
    * background page and popup button
      ...
      * figwheel works
    * content script
      * due to [security restrictions](https://github.com/binaryage/xpath-finder/issues/2), content script has to be provided as a single file
...
This will create a folder `releases/xpath-finder-0.1.0` where 0.1.0 will be current version from [project.clj](project.clj).
